...
See code to generate these slides at [GitHub](https://github.com/HDkarlsen/teachingR)
...
::: {.absolute bottom="-120%" style="font-size:0.8em; padding: 0.5em 1em; background-color: rgba(255, 255, 255, .5); backdrop-filter: blur(5px); box-shadow: 0 0 1rem 0 rgba(0, 0, 0, .5); border-radius: 5px;"}
...
::: {.absolute bottom="-150%" right="0%" style="font-size:0.6em;  padding: 0.1em 0.1em; background-color: rgba(255, 255, 255, 1); backdrop-filter: blur(5px); box-shadow: 0 0 1rem 0 rgba(0, 0, 0, .1); border-radius: 5px;"}
